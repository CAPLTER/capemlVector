---
description: "Use when making non-trivial design or architecture decisions. Points to the local Well-Architected Framework reference material in .github/ai-reference/waf/ (pillar checklists, trade-off prompts, examples) that agents should consult and cite."
---
...
- Pillar checklists and trade-off prompts live in
  [.github/ai-reference/waf/pillars/](../ai-reference/waf/pillars/).
